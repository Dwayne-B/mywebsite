...
function About() {
  return <div className="flex flex-col gap-14 px-6">
...
<button className="about__button hover:border-purple-300 hover:bg-slate-900 w-44  rounded-2xl border border-emerald-300 ">
 Contact
</button>
    </div>
  </article>
